  ...
  return (
    <section className="py-16">
      ...
      <p className="max-w-3xl mx-auto mb-8 text-center text-stone-500 italic">
        ...
        trí tuệ – những người đã viết nên trang sử cuối cùng của cuộc kháng chiến
        chống Mỹ.”
      </p>
        ...
        {IDEOLOGY_STONES.map((stone) => {
          ...
          return (
            <div key={stone.id} className="relative">
              ...
              {/* ✅ PANEL: CHỈ RENDER KHI ACTIVE (KHÔNG CÒN CHIẾM CHỖ) */}
              <AnimatePresence initial={false}>
                {isActive && (
                  <motion.div
                    ...
                    className="mt-4 overflow-hidden rounded-2xl border border-stone-200/80 bg-white/95 backdrop-blur shadow-lg shadow-stone-900/15"
                  >
            ...
            <div className="border-l-4 border-red-600 pl-3 sm:pl-4">
              <p className="text-base sm:text-lg md:text-xl font-semibold text-stone-900 leading-relaxed">
                ...
                <span className="underline decoration-red-500 decoration-2 underline-offset-4">
                  bạn nghĩ điều gì sẽ khiến bạn cảm nhận rõ nhất rằng ‘Chiến thắng
                  đã đến’?
                </span>
              </p>
            </div>
...
function FinalSummarySection() {
  ...
  return (
    <div ref={sectionRef} className="relative mt-16 overflow-hidden rounded-3xl bg-black">
      <div
          ...
          <div className="max-w-3xl text-center text-slate-50">
            ...
            <div className="text-2xl md:text-3xl lg:text-4xl font-serif font-semibold leading-relaxed">
              ...
              <span
                className={
                  isInView
                    ? "block text-lg md:text-2xl lg:text-3xl text-slate-100/90"
                    : "block text-lg md:text-2xl lg:text-3xl text-slate-100/90 opacity-0 translate-y-4"
                }
              >
                – bản hùng ca khép lại chiến tranh, mở ra kỷ nguyên độc lập,
                thống nhất và phát triển của dân tộc Việt Nam.
              </span>
            </div>
          </div>
        </div>
